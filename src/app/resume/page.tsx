...
export const metadata = {
  title: "Brent Bartosch | Resume",
  description: "Enterprise AE with 15+ years selling technical products. Daily Supabase user.",
};
  ...
  return (
    <main className="max-w-[850px] mx-auto px-6 py-12 md:py-16">
      ...
      <div className="mb-6 no-print">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm text-emerald-600 hover:text-emerald-700 no-underline"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
          Back to Lead Scoring Dashboard
        </Link>
      </div>
